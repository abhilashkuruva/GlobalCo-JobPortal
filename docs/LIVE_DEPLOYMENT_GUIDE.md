...
This guide provides the exact, copy-paste instructions to deploy the complete **GlobalCo JobBoard** full-stack platform live to production with **zero cold starts** and **high-speed performance**.
...
3. Connect your repository: bhilashkuruva/GlobalCo-JobPortal.
...
2. Select **Build and deploy from a Git repository** -> Connect bhilashkuruva/GlobalCo-JobPortal.
...
4. Under **Environment Variables**, add:
   ...
   | DB_URL | jdbc:postgresql://<neon-pooler-host>/neondb?sslmode=require&prepareThreshold=0 |
   | DB_USERNAME | 
eondb_owner (or your Neon user) |
   | DB_PASSWORD | <your-neon-password> |
   | JWT_SECRET | 9y&E)H@McQfTjWnZr4u7x!A%C*F-JaNdRgUkXp2s5v8y/B?E(G+KbPeShVmYq |
...
3. Select your repository: bhilashkuruva/GlobalCo-JobPortal.
4. In the configuration screen:
   - **Root Directory**: Click **Edit** and select rontend (CRITICAL!)
...
| Role | Email | Password |
| :--- | :--- | :--- |
| **Admin** | dmin@globalco.com | password |
| **Recruiter** | 
ecruiter@globalco.com | password |
